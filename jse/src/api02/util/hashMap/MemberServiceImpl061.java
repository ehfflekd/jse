...
/*
 ...
 뜨는 데 , 마우스를 대시고 add unimplement를 클릭하세요.
 그럼 자동 오버라이딩이 됩니다. 
 * */
public class MemberServiceImpl061 implements MemberService061{
	Map<String,Object> map = new HashMap<String,Object>();
	MemberVO061 vo = new MemberVO061();
	@Override
	...
	public void login(String id, String password) {
		...
		if(!map.containsKey("id")){//! not 이라는 뜻 하나 이상일때는 () 앞에 ! 표시
